...
export function DeepSelectSection({
  mainNote,
  selectableNotes,
  selectedSubIds,
  selectedCount,
  ...
  return (
    <div className={minimalStyles.section}>
      <div className={minimalStyles.sectionInner}>
        ...
        <div className={deepStyles.selectListBlock}>
          ...
          <div className={deepStyles.selectList}>
            {selectableNotes.length === 0 ? (
              <div className={deepStyles.selectEmpty}>
                연결할 기록이 없습니다.
              </div>
            ) : (
