create table public.emotion_error_details (
  ...
  constraint emotion_error_details_owner_check check (
    (
      (user_id is not null)
...
create index IF not exists emotion_error_details_device_id_idx on public.emotion_error_details using btree (device_id) TABLESPACE pg_default;