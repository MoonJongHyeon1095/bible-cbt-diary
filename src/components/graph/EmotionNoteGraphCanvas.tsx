...
import EmotionNoteGraphNode from "./nodes/EmotionNoteGraphNode";

const NODE_TYPES = { emotion: EmotionNoteGraphNode };
const EDGE_TYPES = {};

type EmotionNoteGraphCanvasProps = {
  children?: ReactNode;
  graphKey: string;
  displayNodes: Node[];
  displayEdges: Edge[];
...
export default function EmotionNoteGraphCanvas({
  children,
  graphKey,
  displayNodes,
  displayEdges,
