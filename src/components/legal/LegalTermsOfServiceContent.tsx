  ...
  return (
    <>
      ...
      <ol className={styles.list}>
        ...
        <li>“회원”이란 회사가 정한 절차에 따라 계정을 생성한 이용자를 말합니다.</li>
        <li>“비회원”이란 계정 없이 서비스를 이용하는 자를 말합니다.</li>
        <li>
          “콘텐츠”란 이용자가 서비스에 입력하거나 생성하는 감정, 생각, 상황, 메모,
          질문 응답 등 모든 기록을 말합니다.
        </li>
        <li>
      ...
      <ol className={styles.list}>
        ...
        <li>
          회사는 관련 법령을 위반하지 않는 범위에서 약관을 변경할 수 있으며, 중요한
          변경 시 서비스 내 공지 등 합리적인 방법으로 고지합니다.
        </li>
        <li>
      ...
      <ol className={styles.list}>
        ...
        <li>AI 기능의 결과물은 참고용 정보이며, 전문가의 판단을 대체하지 않습니다.</li>
        <li>
      ...
      <p>
        자해 또는 자살 충동, 기타 긴급 위험 상황에서는 즉시 119 또는 인근 응급기관에
        연락해야 하며, 서비스는 긴급 대응 수단이 아닙니다.
      </p>

      <h3 className={styles.articleTitle}>제7조(회원가입 및 계정)</h3>
      <ol className={styles.list}>
        <li>
          회원가입은 이메일 기반 자체 회원가입 또는 소셜 로그인(예: Google) 방식으로
          제공될 수 있습니다.
        </li>
      ...
      <ol className={styles.list}>
        ...
        <li>
          비회원의 콘텐츠는 원칙적으로 이용자 기기 내 로컬 저장소에 저장되며, 회사
          서버에는 저장되지 않을 수 있습니다.
        </li>
        <li>
      ...
      <p>
        회원의 콘텐츠는 서비스 제공을 위해 회사의 서버 및 데이터베이스에 저장될 수
        있으며, 삭제 및 보관에 관한 사항은 개인정보 처리방침을 따릅니다.
      </p>

      <h3 className={styles.articleTitle}>제10조(AI 기능)</h3>
      <ol className={styles.list}>
        <li>
          AI 기능은 서비스의 핵심 기능의 일부로 제공되며, 이용자는 서비스 이용을 위해
          해당 기능 이용 및 국외 이전에 동의해야 합니다
        </li>
        <li>
          AI 기능 이용 시 이용자가 입력한 일부 또는 전부의 텍스트가 AI 처리 제공업체
          (국외 포함)로 전송되어 처리될 수 있습니다.
        </li>
        <li>회사는 AI 기능 결과물의 정확성 또는 이용 결과에 대해 책임을 지지 않습니다.</li>
      </ol>

      <h3 className={styles.articleTitle}>제11조(향후 유료 서비스)</h3>
      <p>회사는 향후 유료 서비스 또는 구독 기능을 도입할 수 있습니다.</p>
      <p>
        이 경우 관련 법령에 따라 결제 및 환불 정책을 별도로 고지하고 동의를 받으며,
        결제·정산을 위해 필요한 최소한의 개인정보를 추가로 수집·이용할 수 있습니다.
      </p>
      ...
      <p>
        서비스 및 회사 제공 자료에 대한 권리는 회사 또는 정당한 권리자에게 귀속되며,
        이용자는 서비스 이용 목적 외 사용을 할 수 없습니다.
      </p>
      ...
      <p>
        본 약관은 대한민국 법령을 준거법으로 하며, 분쟁은 민사소송법상 관할 법원을
        따릅니다.
      </p>
    </>
  );
