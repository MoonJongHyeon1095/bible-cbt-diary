create table public.emotion_alternative_details (
  ...
  constraint emotion_alternative_details_owner_check check (
    (
      (user_id is not null)
...
create index IF not exists emotion_alternative_details_device_id_idx on public.emotion_alternative_details using btree (device_id) TABLESPACE pg_default;