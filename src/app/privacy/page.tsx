      ...
      <main className={styles.main}>
        <div className={styles.shell}>
          <section className={styles.card}>
            ...
            <p>
              마인드 렌즈(이하 “회사”)은 「개인정보 보호법」 등 관련 법령을
              준수하며 이용자의 개인정보 보호를 위해 본 방침을 수립합니다.
            </p>
            ...
            <ul className={styles.list}>
              ...
              <li>
                <strong>
                  서비스 안정화 및 보안 목적의 최소한의 서버 접속 로그가 생성될
                  수 있음
                </strong>
              </li>
            </ul>
            ...
            <ul className={styles.list}>
              ...
              <li>회원: 회사 DB 저장</li>
              <li>
                회사는 접근통제, 암호화, 최소권한 등 보호조치를 적용합니다.
              </li>
            </ul>
            ...
            <p>
              회사는 원칙적으로 개인정보를 제3자에게 제공하지 않습니다. 다만
              법령에 따른 경우 제공될 수 있습니다.
            </p>
            ...
            <p>
              ...
              로그로 저장될 수 있으며, 회사는 민감 정보 최소화를 위한 보호조치를
              적용합니다.
            </p>

            <h3 className={styles.articleTitle}>8. 이용자 권리</h3>
            <p>
              이용자는 개인정보 열람, 정정, 삭제, 처리정지, 동의 철회를 요청할
              수 있습니다.
            </p>
